...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    private IconFontImageView mEmptyBtn;
...
//            }
    ...
    private void initiateView() {
        ...
        mBackBtn = (IconFontImageView) mSearchLayout.findViewById(R.id.action_up_btn);
        mVoiceBtn = (ImageButton) mSearchLayout.findViewById(R.id.action_voice_btn);
        mEmptyBtn = (IconFontImageView) mSearchLayout.findViewById(R.id.action_empty_btn);
...
//        mBackBtn.setImageDrawable(drawable);
    ...
    /**
     * if show is true, this will enable voice search. If voice is not available on the device, this method call has not
     * effect.
     *
     * @param show
     */
