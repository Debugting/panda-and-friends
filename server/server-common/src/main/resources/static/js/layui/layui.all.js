...
!function () {
    ...
    C.prototype = [], C.prototype.constructor = C, w.extend = function () {
        ...
        var t, a, i = this, r = (new Date, i.config), o = r.dateTime = r.dateTime || i.systemDate(),
            ...
            c = function (e) {
                e.year > d[1] && (e.year = d[1], a = !0), e.month > 11 && (e.month = 11, a = !0), e.hours > 23 && (e.hours = 0, a = !0), e.minutes > 59 && (e.minutes = 0, e.hours++, a = !0), e.seconds > 59 && (e.seconds = 0, e.minutes++, a = !0), t = n.getendTime(e.month + 1, e.year), e.date > t && (e.date = t, a = !0)
            }, m = function (e, t, n) {
        ...
        return "limit" === e ? (c(o), i) : (l = l || r.value, "string" == typeof l && (l = l.replace(/\s+/g, " ").replace(/^\s|\s$/g, "")), i.startState && !i.endState && (delete i.startState, i.endState = !0), "string" == typeof l && l ? i.EXP_IF.test(l) ? r.range ? (l = l.split(" " + r.range + " "), i.startTime = i.startTime || i.systemDate(), i.endTime = i.endTime || i.systemDate(), r.dateTime = w.extend({}, i.startTime), w.each([i.startTime, i.endTime], function (e, t) {
            m(t, l[e], e)
        })) : m(o, l) : (i.hint("日期格式不合法<br>必须遵循下述格式：<br>" + (r.range ? r.format + " " + r.range + " " + r.format : r.format) + "<br>已为你重置"), a = !0) : l && l.constructor === Date ? r.dateTime = i.systemDate(l) : (r.dateTime = i.systemDate(), delete i.startState, delete i.endState, delete i.startTime, delete i.endTime, delete i.startTime, delete i.endTime), c(o), a && l && i.setValue(r.range ? i.endTime ? i.parse() : "" : i.parse()), e && e(), i)
        ...
        var i, r = this, o = r.config, l = {}, d = o[n > 41 ? "endTime" : "dateTime"], c = w.extend({}, d, t || {});
        ...
        if (l.year < d[0] && (l.year = d[0], r.hint("最低只能支持到公元" + d[0] + "年")), l.year > d[1] && (l.year = d[1], r.hint("最高只能支持到公元" + d[1] + "年")), r.firstDate || (r.firstDate = w.extend({}, l)), c.setFullYear(l.year, l.month, 1), t = c.getDay(), a = n.getendTime(l.month || 12, l.year), i = n.getendTime(l.month + 1, l.year), w.each(y, function (e, n) {
        ...
        }), w(f[0]).attr("lay-ym", l.year + "-" + (l.month + 1)), w(f[1]).attr("lay-ym", l.year + "-" + (l.month + 1)), "cn" === s.lang ? (w(f[0]).attr("lay-type", "year").html(l.year + "年"), w(f[1]).attr("lay-type", "month").html(l.month + 1 + "月")) : (w(f[0]).attr("lay-type", "month").html(m.month[l.month]), w(f[1]).attr("lay-type", "year").html(l.year)), u && (s.range && (e ? r.endTime = r.endTime || {
            year: l.year + ("year" === s.type ? 1 : 0),
            month: l.month + ("month" === s.type ? 0 : -1)
        } : r.startTime = r.startTime || {
            year: l.year,
            month: l.month
        }, e && (r.listYM = [[r.startTime.year, r.startTime.month + 1], [r.endTime.year, r.endTime.month + 1]], r.list(s.type, 0).list(s.type, 1), "time" === s.type ? r.setBtnStatus("时间", w.extend({}, r.systemDate(), r.startTime), w.extend({}, r.systemDate(), r.endTime)) : r.setBtnStatus(!0))), s.range || (r.listYM = [[l.year, l.month + 1]], r.list(s.type, 0))), s.range && !e) {
        ...
        if (y && h.removeChild(y), h.appendChild(d), "year" === e || "month" === e) w(n.elemMain[t]).addClass("laydate-ym-show"), w(d).find("li").on("click", function () {
            ...
            if (!w(this).hasClass(s)) {
                if (0 === t) i[e] = r, l && (n.startTime[e] = r), n.limit(w(n.footer).find(g), null, 0); else if (l) n.endTime[e] = r; else {
                    var c = "year" === e ? n.getAsYM(r, T[1] - 1, "sub") : n.getAsYM(T[0], r, "sub");
                    w.extend(i, {year: c[0], month: c[1]})
                }
                "year" === a.type || "month" === a.type ? (w(d).find("." + o).removeClass(o), w(this).addClass(o), "month" === a.type && "year" === e && (n.listYM[t][0] = r, l && (n[["startTime", "endTime"][t]].year = r), n.list("month", t))) : (n.checkDate("limit").calendar(), n.closeList()), n.setBtnStatus(), a.range || n.done(null, "change"), w(n.footer).find(D).removeClass(s)
            }
        }); else {
            ...
            k(), S.innerHTML = a.range ? [r.startTime, r.endTime][t] : r.timeTips, w(n.elemMain[t]).addClass("laydate-time-show"), H[0] && H.remove(), c[2].appendChild(S), w(d).find("ol").each(function (e) {
                ...
                w(t).find("li").on("click", function () {
                    ...
                    w(this).hasClass(s) || (a.range ? n[x][C[e]] = r : i[C[e]] = r, w(t).find("." + o).removeClass(o), w(this).addClass(o), E(), k(), (n.endTime || "time" === a.type) && n.done(null, "change"), n.setBtnStatus())
                })
            })
        }
        return n
        ...
        d && (t = t || i.startTime, n = n || i.endTime, a = i.newDate(t).getTime() > i.newDate(n).getTime(), i.limit(null, t) || i.limit(null, n) ? o.addClass(s) : o[a ? "addClass" : "removeClass"](s), e && a && i.hint("string" == typeof e ? l.replace(/日期/g, e) : l))
    }, T.prototype.parse = function (e, t) {
        var n = this, a = n.config,
            i = t || (e ? w.extend({}, n.endTime, n.endTime) : a.range ? w.extend({}, n.startTime, n.startTime) : a.dateTime),
            r = n.format.concat();
        ...
        if (a.range && !n.endTime && w(n.footer).find(g).addClass(s), n.endTime) return e = n.newDate({
            year: n.startTime.year,
            month: n.startTime.month,
            date: n.startTime.date
        }).getTime(), t = n.newDate({
            year: n.endTime.year,
            month: n.endTime.month,
            date: n.endTime.date
        ...
        var n = this, a = n.config, i = w.extend({}, n.startTime ? w.extend(n.startTime, n.startTime) : a.dateTime),
            r = w.extend({}, w.extend(n.endTime, n.endTime));
        ...
        var t = this, n = t.config, a = n.dateTime, i = w(t.elem).find("td"), r = e.attr("lay-ymd").split("-"),
            l = function (e) {
                new Date;
                e && w.extend(a, r), n.range && (t.startTime ? w.extend(t.startTime, r) : t.startTime = w.extend({}, r, t.startTime), t.startYMD = r)
            };
        if (r = {year: 0 | r[0], month: (0 | r[1]) - 1, date: 0 | r[2]}, !e.hasClass(s)) if (n.range) {
            if (w.each(["startTime", "endTime"], function (e, n) {
                t[n] = t[n] || {hours: 0, minutes: 0, seconds: 0}
            }), t.endState) l(), delete t.endState, delete t.endTime, t.startState = !0, i.removeClass(o + " " + u), e.addClass(o); else if (t.startState) {
                if (e.addClass(o), t.endTime ? w.extend(t.endTime, r) : t.endTime = w.extend({}, r, t.endTime), t.newDate(r).getTime() < t.newDate(t.startYMD).getTime()) {
                    var d = w.extend({}, t.endTime, {
                        hours: t.startTime.hours,
                        minutes: t.startTime.minutes,
                        seconds: t.startTime.seconds
                    });
                    w.extend(t.endTime, t.startTime, {
                        hours: t.endTime.hours,
                        minutes: t.endTime.minutes,
                        seconds: t.endTime.seconds
                    }), t.startTime = d
                }
                n.showBottom || t.done(), t.stampRange(), t.endState = !0, t.done(null, "change")
            } else e.addClass(o), l(), t.startState = !0;
            w(t.footer).find(g)[t.endTime ? "removeClass" : "addClass"](s)
        ...
        var n = this, a = n.config, i = a.dateTime, r = "static" === a.position, o = {
            datetime: function () {
                ...
                n.setValue("").remove(), r && (w.extend(i, n.firstDate), n.calendar()), a.range && (delete n.startState, delete n.endState, delete n.endTime, delete n.startTime, delete n.endTime), n.done(["", {}, {}])
            }, now: function () {
                var e = new Date;
                ...
                if (a.range) {
                    if (!n.endTime) return n.hint("请先选择日期范围");
        ...
        var t = this, n = t.config, a = n.dateTime, i = n.range && ("year" === n.type || "month" === n.type),
            r = t.elemCont[e || 0], o = t.listYM[e], s = function (s) {
                var l = ["startTime", "endTime"][e], d = w(r).find(".laydate-year-list")[0],
